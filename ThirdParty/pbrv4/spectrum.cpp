...
namespace pbrt {
    ...
    float SpectrumToPhotometric(Spectrum* s)
    {
        ...
        const Spectrum* c_s = nullptr; //illuminant is a const, so need to handle const
        if (auto l = dynamic_cast<RGBIlluminantSpectrum*>(s))
            c_s = l->Illuminant();

        if (c_s == nullptr)
            return InnerProduct(&Spectra::Y(), s);
        else
            return InnerProduct(&Spectra::Y(), c_s);
    }
    ...
    float PiecewiseLinearSpectrum::Query(float lambda) const
    {
        ...
        //d//check(lambda >= lambdas[o] && lambda <= lambdas[o + 1]);
    ...
    PiecewiseLinearSpectrum::PiecewiseLinearSpectrum(std::span<const float> l, std::span<const float> v)
    ...
    std::string PiecewiseLinearSpectrum::ToString() const
    {
        ...
        // return ret + " ]";
        return "PiecewiseLinearSpectrum::ToString()";
    }
    ...
    PiecewiseLinearSpectrum* PiecewiseLinearSpectrum::FromInterleaved(std::span<const float> samples, bool normalize)
    {
        ...
        PiecewiseLinearSpectrum* spec = new pbrt::PiecewiseLinearSpectrum(lambda, v); //raw pointer
    ...
    {
        return "[ BlackbodySpectrum T: " + std::to_string(T);
    ...
    {
        return "[ ConstantSpectrum c: " + std::to_string(c);
    ...
    std::string DenselySampledSpectrum::ToString() const
    {
        ...
        //s += "] ]";
        // return s;
        return "DenseltySampledSpectrum::ToString()";
    }
    ...
    std::string SampledWavelengths::ToString() const
    {
        ...
        for (size_t i = 0; i < lambda.size(); ++i)
            r += std::to_string(lambda[i]) + " ";
        r += "] pdf: [";
         for (size_t i = 0; i < lambda.size(); ++i)
             r += std::to_string(pdf[i]) + " ";
        r += "] ]";
    ...
    {
        //d//check_LE(std::max({ rgb.r, rgb.g, rgb.b }), 1);
        //d//check_GE(std::min({ rgb.r, rgb.g, rgb.b }), 0);
        rsp = cs.ToRGBCoeffs(rgb);
    }

    RGBUnboundedSpectrum::RGBUnboundedSpectrum(const RGBColorSpace& cs, RGB rgb)
    {
        float m = std::max(rgb.r, rgb.g);
        m = std::max(m, rgb.b);
        scale = 2 * m;
        rsp = cs.ToRGBCoeffs(scale ? rgb / scale : RGB(0, 0, 0));
    }

    RGBIlluminantSpectrum::RGBIlluminantSpectrum(const RGBColorSpace& cs, RGB rgb) : illuminant(&cs.illuminant) 
    {
        float m = std::max(rgb.r, rgb.g);
        m = std::max(m, rgb.b);
        scale = 2 * m;
    ...
    std::string RGBIlluminantSpectrum::ToString() const
    {
        ...
        namespace {
            ...
            static  const float CIE_Illum_A[] = {
            ...
            static const float CIE_S_lambda[nCIES] = {
            ...
            static  const float CIE_S0[nCIES] = {
            ...
            static const float CIE_S1[nCIES] = {
            ...
            static const float CIE_S2[nCIES] = {
            ...
            static const float CIE_Illum_D5000[] = {
            ...
            // --
            // >    cct = 6000.
            static const float ACES_Illum_D60[] = {
            ...
            static const float CIE_Illum_D6500[] = {
            ...
            static const float CIE_Illum_F1[] = {
            ...
            static const float CIE_Illum_F2[] = {
            ...
            static const float CIE_Illum_F3[] = {
            ...
            static const float CIE_Illum_F4[] = {
            ...
            static const float CIE_Illum_F5[] = {
            ...
            static const float CIE_Illum_F6[] = {
            ...
            static const float CIE_Illum_F7[] = {
            ...
            static const float CIE_Illum_F8[] = {
            ...
            static const float CIE_Illum_F9[] = {
            ...
            static const float CIE_Illum_F10[] = {
            ...
            static const float CIE_Illum_F11[] = {
            ...
            static const float CIE_Illum_F12[] = {
            ...
            static const float GlassBK7_eta[] = {
            ...
            static const float GlassBAF10_eta[] = {
            ...
            static const float GlassFK51A_eta[] = {
            ...
            static const float GlassLASF9_eta[] = {
            ...
            static const float GlassSF5_eta[] = {
            ...
            static const float GlassSF10_eta[] = {
            ...
            static const float GlassSF11_eta[] = {
            ...
            // Copyright (c) 2020, Weta Digital, Ltd.
            // SPDX-License-Identifier: Apache-2.0
            static const float canon_eos_100d_r[] = {
            ...
            static const float canon_eos_100d_g[] = {
                ...
                720.0, 0.0014271277999999932 };
            static const float canon_eos_100d_b[] = {
            ...
            static const float canon_eos_1dx_mkii_r[] = {
                ...
                720.0, 0.0006460381 };
            static const float canon_eos_1dx_mkii_g[] = {
                ...
                720.0, 0.0006460381 };
            static const float canon_eos_1dx_mkii_b[] = { 380.0, 0.0010143081000000276,
            ...
            static const float canon_eos_200d_r[] = {
            ...
            static const float canon_eos_200d_g[] = {
                ...
                720.0, 0.0009626299999999977 };
            static const float canon_eos_200d_b[] = {
            ...
            static const float canon_eos_200d_mkii_r[] = {
            ...
            static const float canon_eos_200d_mkii_g[] = { 380.0, 0.0014539171999999878,
                                                   ...
                                                   720.0, 0.0006469792000000007 };
            static const float canon_eos_200d_mkii_b[] = {
            ...
            static const float canon_eos_5d_r[] = {
            ...
            static const float canon_eos_5d_g[] = { 380.0, 0.0013068287999999997, 390.0, 0.000843798899999999,
                                            ...
                                            720.0, 0.0039319256000000065 };
            static const float canon_eos_5d_b[] = { 380.0, 0.000758327000000017,
            ...
            static const float canon_eos_5d_mkii_r[] = {
                ...
                720.0, 0.0008906563 };
            static const float canon_eos_5d_mkii_g[] = {
                ...
                720.0, 0.0008906563 };
            static const float canon_eos_5d_mkii_b[] = {
            ...
            static const float canon_eos_5d_mkiii_r[] = {
            ...
            static const float canon_eos_5d_mkiii_g[] = {
                ...
                720.0, 0.0006878099999999997 };
            static const float canon_eos_5d_mkiii_b[] = {
            ...
            static const float canon_eos_5d_mkiv_r[] = {
            ...
            static const float canon_eos_5d_mkiv_g[] = {
                ...
                720.0, 0.000838734099999999 };
            static const float canon_eos_5d_mkiv_b[] = { 380.0, 0.0008804458000000182,
            ...
            static const float canon_eos_5ds_r[] = {
            ...
            static const float canon_eos_5ds_g[] = { 380.0, 0.0024321118000000252,
                                             ...
                                             720.0, 0.0014527802000000008 };
            static const float canon_eos_5ds_b[] = {
            ...
            static const float canon_eos_m_r[] = { 380.0, 0.0017825097,         390.0, 0.0019753785999999988,
            ...
            static const float canon_eos_m_g[] = { 380.0, 0.0017905516999999899, 390.0, 0.0017254255999999977,
                                           ...
                                           720.0, 0.0012172206999999993 };
            static const float canon_eos_m_b[] = {
            ...
            static const float hasselblad_l1d_20c_r[] = {
            ...
            static const float hasselblad_l1d_20c_g[] = {
                ...
                720.0, 0.0014381367999999999 };
            static const float hasselblad_l1d_20c_b[] = {
            ...
            static const float nikon_d810_r[] = { 380.0, 0.0005731851999999926, 390.0, 0.0004202495000000042,
            ...
            static const float nikon_d810_g[] = { 380.0, 0.0011608844999999451, 390.0, 0.0007257054999999998,
                                          ...
                                          720.0, 0.0007327225999999986 };
            static const float nikon_d810_b[] = {
            ...
            static const float nikon_d850_r[] = { 380.0, 0.0013240464000000025, 390.0, 0.001664802299999998,
            ...
            static const float nikon_d850_g[] = { 380.0, 0.0012335690999999982, 390.0, 0.0009321669999999996,
                                          ...
                                          720.0, 0.0015179675000000004 };
            static const float nikon_d850_b[] = {
            ...
            static const float sony_ilce_6400_r[] = {
            ...
            static const float sony_ilce_6400_g[] = {
                ...
                720.0, 0.0003404241999999994 };
            static const float sony_ilce_6400_b[] = {
            ...
            static const float sony_ilce_7m3_r[] = {
            ...
            static const float sony_ilce_7m3_g[] = { 380.0, 0.0012680627999999972,
                                             ...
                                             720.0, 0.0006031914999999985 };
            static const float sony_ilce_7m3_b[] = {
            ...
            static const float sony_ilce_7rm3_r[] = {
            ...
            static const float sony_ilce_7rm3_g[] = { 380.0, 0.0013278868999999976,
                                              ...
                                              720.0, 0.0008196537999999986 };
            static const float sony_ilce_7rm3_b[] = {
            ...
            static const float sony_ilce_9_r[] = { 380.0, 0.0006438935000000756, 390.0, 0.0005447983000000049,
            ...
            static const float sony_ilce_9_g[] = { 380.0, 0.001388401600000061,  390.0, 0.0009337119999999824,
                                           ...
                                           720.0, 0.0005996684000000017 };
            static const float sony_ilce_9_b[] = {
            ...
            DenselySampledSpectrum D(float temperature)
            {
                ...
                if (cct < 4000)
                {
                    ...
                    DenselySampledSpectrum blackbody = DenselySampledSpectrum::SampleFunction(
                        [=](float lambda) { return bb.Query(lambda); });
                ...
                float x;
                if (cct <= 7000)
                    x = -4.607f * 1e9f / pow(cct, 3) + 2.9678f * 1e6f / pow(cct, 2) +
                    0.09911f * 1e3f / cct + 0.244063f;
                else
                    x = -2.0064f * 1e9f / pow(cct, 3) + 1.9018f * 1e6f / pow(cct, 2) +
        ...
        namespace Spectra {
            ...
            void Init()
            {
                ...
                Spectrum* illuma = PiecewiseLinearSpectrum::FromInterleaved(CIE_Illum_A, true);
                Spectrum* illumd50 =
                ...
                Spectrum* ageta = PiecewiseLinearSpectrum::FromInterleaved(Ag_eta, false);
                Spectrum* agk = PiecewiseLinearSpectrum::FromInterleaved(Ag_k, false);
                Spectrum* aleta = PiecewiseLinearSpectrum::FromInterleaved(Al_eta, false);
                
                Spectrum* alk = PiecewiseLinearSpectrum::FromInterleaved(Al_k, false);
                Spectrum* aueta = PiecewiseLinearSpectrum::FromInterleaved(Au_eta, false);
                Spectrum* auk = PiecewiseLinearSpectrum::FromInterleaved(Au_k, false);
                Spectrum* cueta = PiecewiseLinearSpectrum::FromInterleaved(Cu_eta, false);
                Spectrum* cuk = PiecewiseLinearSpectrum::FromInterleaved(Cu_k, false);
                Spectrum* cuzneta = PiecewiseLinearSpectrum::FromInterleaved(CuZn_eta, false);
                Spectrum* cuznk = PiecewiseLinearSpectrum::FromInterleaved(CuZn_k, false);
                Spectrum* mgoeta = PiecewiseLinearSpectrum::FromInterleaved(MgO_eta, false);
                Spectrum* mgok = PiecewiseLinearSpectrum::FromInterleaved(MgO_k, false);
                Spectrum* tio2eta = PiecewiseLinearSpectrum::FromInterleaved(TiO2_eta, false);
                Spectrum* tio2k = PiecewiseLinearSpectrum::FromInterleaved(TiO2_k, false);
        ...
        std::string FindMatchingNamedSpectrum(Spectrum* s)
        {
            auto sampledLambdasMatch = [](Spectrum* a, Spectrum* b)
            {
                ...
                for (float lambda : wls)
                    if (a->Query(lambda) != b->Query(lambda))
                        return false;
                return true;
            };
